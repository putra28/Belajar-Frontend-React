...
const ManageSupplier = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const response = await fetch('http://168.168.10.12:2805/api/pemasok/getdatapemasok', {
  ...
  const columnsProduk = [
    ...
    {
      name: 'Nama Supplier',
      selector: row => row.M_namaPemasok,
      sortable: true,
    },
    {
      name: 'Kontak Supplier',
      selector: row => row.M_kontakPemasok,
      sortable: true,
    },
    {
      name: 'Alamat Pemasok',
      selector: row => row.M_alamatPemasok,
      sortable: true,
    },
  ];
